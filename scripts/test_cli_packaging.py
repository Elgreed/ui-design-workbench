...
class CliPackagingTests(unittest.TestCase):
    ...
    def test_generic_handoff_is_default_and_codex_is_optional(self) -> None:
        ...
        self.assertIn('data-version-visibility="before"', generic)
        self.assertIn('data-version-visibility="both"', generic)
        self.assertIn('data-version-visibility="after"', generic)
