...
- Anchor finding markers in canvas coordinates and remeasure them after zoom, canvas/device scroll, resize, version change, and panel layout change. Middle-button drag pans the whole canvas and must not activate the mockup or lose marker click handling.
