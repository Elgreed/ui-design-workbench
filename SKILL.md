...
7. Build the editor chrome with [references/workbench-ui.md](references/workbench-ui.md). Provide All screens, Prototype, and Single screen; expose Problems, Before, and After as independent canvas-visibility toggles when their data exists. Keep Interact, Inspect, and Comment independent. Iterate in IR, never in generated HTML.
