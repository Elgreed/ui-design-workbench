...
- Режимы «Все экраны», «Прототип», «Один экран» и стабильная локализованная группа «До / Сравнение / После» с раздельным или наложенным сравнением.
- Общий масштабируемый холст с перемещением зажатым колёсиком, сворачиваемые и регулируемые панели, инспектор, комментарии и экспорт решений.
